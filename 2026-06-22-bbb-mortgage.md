# Bed Bath & Beyond Is Selling Mortgages Now

- **Type:** Talking Head (News)
- **Status:** Scripted
- **Date approved:** 2026-06-22
- **CTA:** Leave a comment
- **Image asset:** Two options built for film-time pick — bbb-mortgage-headline-card.png (Option A), bbb-mortgage-cart-card.png (Option B)
...
```
IMAGE OPTION (both built — pick at film time):
- Option A: ✅ bbb-mortgage-headline-card.png — headline screenshot + source overlay (HousingWire, Jun 2026)
- Option B: ✅ bbb-mortgage-cart-card.png — "🛒 Mortgage — add to cart?" playful cart mockup
- Option C: "What decides your loan's cost: Rate / Fees (APR) / Who's guiding you" 3-item card (not built)
```

## CAPTIONS
- Caption 1: Bed Bath & Beyond is selling mortgages now. 🛒 Convenient — but here's why "easiest" almost never means "cheapest." 👇
- Caption 2: You'll soon buy a house where you buy your towels. Before you add a mortgage to the cart, read this.
- Caption 3: Would you get a mortgage from Bed Bath & Beyond?? Genuinely asking — but first, the 3 things that actually decide your loan. 💸
